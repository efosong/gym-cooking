...
class DeepAgent:
    ...
    def get_action(self, observation):
        logits = self.policy(torch.Tensor(observation))
...
def run_game(cfg):
    ...
    nw = DeepAgent("cooking_zoo/outputs/actors/shelby-whiting.pt")
    ne = DeepAgent("cooking_zoo/outputs/actors/cyril-fountain.pt")
    sw = DeepAgent("cooking_zoo/outputs/actors/crissy-paine.pt")
    se = DeepAgent("cooking_zoo/outputs/actors/kylie-eales.pt")
    agents = [nw, ne, sw, se]
